# @makepdfform/converter

> **MakePDFForm vendored package** — This is a fork of [`@pdfme/converter`](https://github.com/pdfme/pdfme/tree/main/packages/converter) from the [pdfme](https://github.com/pdfme/pdfme) project.
> Licensed under MIT. Copyright (c) 2020 HandDot. See [LICENSE](./LICENSE) and [NOTICE.md](../../NOTICE.md).
