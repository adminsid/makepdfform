import type { Plugin, Schema } from '@makepdfform/common';
import { ZOOM } from '@makepdfform/common';
  ...
  ui: async (arg) => {
    ...
    if (context) {
      ...
      try {
        ...
        signaturePad.clear();
        showLoadError();
        console.error('[@makepdfform/schemas] Failed to restore saved signature data.', error);
      }
