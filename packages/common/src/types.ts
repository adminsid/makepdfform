import { z } from 'zod';
import type { PDFPage, PDFDocument } from '@makepdfform/pdf-lib';
import {
  Lang,
  Dict,
  Mode,
 ...
 * @property {typeof import('@makepdfform/pdf-lib')} pdfLib The pdf-lib library used for rendering.
...
export interface PDFRenderProps<T extends Schema> {
  ...
  schema: T;
  basePdf: BasePdf;
  pdfLib: typeof import('@makepdfform/pdf-lib');
  pdfDoc: PDFDocument;
  page: PDFPage;
