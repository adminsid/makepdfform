import { getFallbackFontName, mm2pt, pt2mm, type Font } from '@makepdfform/common';
...
export const resolveFontVariant = (
  ...
  if (
    ...
    throw new Error(
      `[@makepdfform/schemas] Missing font variant for markdown text in field "${schema.name}".`,
    );
  }
