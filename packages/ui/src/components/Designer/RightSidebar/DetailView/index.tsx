...
import { isBlankPdf } from '@makepdfform/common';
import { TEXT_OVERFLOW_EXPAND, TEXT_OVERFLOW_VISIBLE } from '@makepdfform/schemas/texts';
...
const DetailView = (props: DetailViewProps) => {
  ...
  if (!activePlugin) {
    throw Error(`[@makepdfform/ui] Failed to find plugin used for ${activeSchema.type}`);
  }
