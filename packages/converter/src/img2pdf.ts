import { PDFDocument } from '@makepdfform/pdf-lib';
import { mm2pt } from '@makepdfform/common';
...
export async function img2pdf(
  ...
  try {
    ...
    throw new Error(`[@makepdfform/converter] img2pdf failed: ${(error as Error).message}`);
  }
}
